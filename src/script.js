let playlist = [ {
  'title': '2pac - Do for love',
  'audio': "musica/DoForLove.mp3",
}, {
  'title': 'Nanpa Basico ft.Lefty - Pedacito de tierra ',
  'audio': "musica/PedacitoDeTierra.mp3",
}, {
  'title': 'Proof - imsomnio',
  'audio': "musica/insomnio.mp3",
}, {
  'title': 'Proof - Especies',
  'audio': "musica/especies.mp3",
},  {
  'title': 'Solitario Mondragon - Besame lento ',
  'audio': "musica/BesameLento.mp3",
},{
  'title': 'Canserbero -  de la vida como pelicula , tragedia , comedia y ficcion',
  'audio': "musica/De la Vida Como Pelicula, Tragedia, Comedia y Ficcion.mp3"
},{
  'title': 'Santiago Insane - Aqui murio el payaso',
  'audio': "musica/Aquí murió el payaso - Karter 2h.mp3"
},{
  'title': 'Horus - Redi',
  'audio': "musica/HORUS  REDI.mp3"
},{
  'title' : 'Canserbero - Cest la Mort',
  'audio': "musica/Canserbero - Cest la Mort (Video Oficial).mp3"
},{
  'title' : 'Canserbero - Ley del hielo',
  'audio': "musica/Ley del Hielo.mp3"
}
 ];
i = 0;
